...
## 6. 1 週間の標準ルーチン (author 向け、予算: 週 3〜5 時間)

- 月: 指標を 5.1 の表に従い記録 (15 分)
- 火〜木: 記事執筆 or 登壇準備 (合計 2.5〜4 時間)
- 金: 記事公開 + X 投稿 (公開は金曜午前〜昼が Zenn のゴールデン)
- 随時: 反応への返信、自作 hook 系の新着記事へのコメント
  (攻撃的にならず「この bypass は通ります、こういう対策があります」)

週 1 本ペースが予算的に厳しい週は、記事を隔週に落としてよい。
その場合も月曜の指標記録と反応への返信だけは毎週続ける —
止めると 5.2 のマイルストーン判定ができなくなる。
Phase 1 の記事 3 本は「6 週間で 3 本」が満たせれば隔週でも成立する。
